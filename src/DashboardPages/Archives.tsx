...
const Archives = () => {
  ...
  const handleDownload = (date: string, users: User[]) => {
    ...
    const logoWidth = 30;
    const logoHeight = 30;
    doc.addImage(logo, "PNG", 10, headerYPosition, logoWidth, logoHeight);
    ...
    const startY = 50;
    const rowHeight = 10;
    const colWidths = [60, 60, 60, 40]; // Adjust column widths for name, email, address, and category
    const tableWidth = colWidths.reduce((a, b) => a + b, 0);
    const centerX = (doc.internal.pageSize.width - tableWidth) / 2;
